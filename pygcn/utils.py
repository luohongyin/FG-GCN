...
def load_data_new(dataset_str="cora"): # citeseer, cora, pubmed
    ...
    for i in range(len(names)):
        with open("../data_all/ind.{}.{}".format(dataset_str, names[i]), 'rb') as f:
    ...
    test_idx_reorder = parse_index_file("../data_all/ind.{}.test.index".format(dataset_str))
    ...
    idx_test = test_idx_range.tolist() #[:-100]
